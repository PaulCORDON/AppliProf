...
export class ParamEm2 extends ParamMath {
    ...
    public constructor(typeRep: Number, nbCalcul: Number, valMaxOperande: Number, nombrePair: Boolean, nombreImpair: Boolean, repDeuxBornes: Boolean, repQuatreBornes: Boolean, repPaveNum: Boolean, t: Number, p: Boolean, o: Boolean[])
        /**
